...
const { errorHandler, home, user, room, rate, season, type_room, reservation, season_date, invoice, invoice_detail, services, detail_reservation, image } = require('@golden-cat/api')
...
// Archivos estáticos: imágenes subidas al servidor (reemplazo de Firebase Storage)
...
app.use('/detail_reservation', detail_reservation)
app.use('/image', image)
