      ...
      <v-layout  row>
       ...
       <div > DATOS CUENTA</div>
        ...
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="blue darken-4" flat @click="dialog = false">Close</v-btn>
            <v-btn color="blue darken-4" flat @click="dialog = false">Save</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
        </v-flex>
